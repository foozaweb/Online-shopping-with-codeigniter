                ...
                <div class="product-box">
                        ...
                        <div class="sortby">
                            ...
                            <select class="sort-box" name="sortShop">
                                <option value="date_created" <?php
                                                                if ($this->session->userdata('sortShop') == 'date_created') {
                                                                    echo 'selected disabled';
                                                                }
                                                                ?>>Date
                                </option>
                                <option value="product_name" <?php
                                                                if ($this->session->userdata('sortShop') == 'product_name') {
                                                                    echo 'selected disabled';
                                                                } ?>>Name
                                </option>
                                <option value="<?php echo $this->session->userdata('price_variable') ?>" <?php
                                                                                                            if ($this->session->userdata('sortShop') == $this->session->userdata('price_variable')) {
                                                                                                                echo 'selected disabled';
                                                                                                            } ?>>Price
                                </option>
                                <option value="rating" <?php
                                                        if ($this->session->userdata('sortShop') == 'rating') {
                                                            echo 'selected disabled';
                                                        } ?>>Rating
                                </option>
                            </select>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            <div class="tab-item">
                                                ...
                                                <div class="tab-heading">
                                                    <p><a href="<?php echo base_url() ?>product/<?php echo $shop['productId'] ?>"><?php echo $shop['product_name'] ?> </a></p>
                                                </div>
                                                    ...
                                                    <div class="col-lg-8 col-md-12">
                                                        <div class="item-heading d-flex justify-content-between">
                                                            ...
                                                            <div class="item-price">
                                                                <ul class="list-unstyled list-inline price">
                                                                    <li class="list-inline-item"> <?php echo $this->session->userdata('ex_symbol') ?><?php echo number_format($shop[$this->session->userdata('price_variable')]/$this->session->userdata('ex_symbol')); ?>.00</li>
                                                                    <li class="list-inline-item"></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                    ...
                    <?php } else { ?>
                        <center class="mb-5 mt-5">
                            <h5 class="card">
                                <div class="card-body">
                                    <h4>Sorry! We didn't find any item like <strong>'<?php echo $find ?>'</strong> in our store. Try browsing the<a class="cartExpand" href="<?php echo base_url() ?>shop"><i class="fa fa-shopping-basket"></i> store?</a></h4>
                                </div>
                            </h5>
                        </center>
                    <?php } ?>
