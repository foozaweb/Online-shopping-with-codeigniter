                            ...
                            <div class="row">
                                ...
                                foreach ($shops as $shop) { ?>
                                    <div class="col-lg-3 col-6">
                                        <div class="tab-item">
                                            <div class="tab-img">
                                                <a href="<?php echo base_url() ?>product/<?php echo $shop['productId'] ?>">
                                            ...
                                            <div class="img-content d-flex justify-content-between">
                                                <div>
                                                    ...
                                                    <ul class="list-unstyled list-inline price">
                                                        <li class="list-inline-item">₦<?php echo number_format($shop[$this->session->userdata('price_variable')]); ?>.00</li>
